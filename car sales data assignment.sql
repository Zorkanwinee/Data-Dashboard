-- 1)	We need to know the sales manager’s full name, his total sales (based on car price), and the percentage of his target left (based on car price
...
-- 3)	Who has the least and the most deposit collected as a percentage
-- of the total price of cars sold by each sales manager? 
-- We want the Manager's name, the deposit collected as a percentage 
-- of the total price, and a third column that has Max or Min tags 
...
4-- Which car contributed to the minimum sales for each sales manager and what 
-- is the amount? (We want the Sales Manager's Name, the Name of the Car
...
-- We want to find the average number of days from one sale to the next
